...
export const bookings: Booking[] = [
  ...
  },
  {
    ...
    eta: "12 min",
    statusTimeline: [
      { label: "Request submitted", time: "Today, 8:30 AM", completed: true },
      { label: "Provider confirmed", time: "Today, 8:45 AM", completed: true },
      { label: "On the way", time: "Today, 9:48 AM", completed: true, active: true },
      { label: "In progress", completed: false },
      { label: "Completed", completed: false },
    ],
